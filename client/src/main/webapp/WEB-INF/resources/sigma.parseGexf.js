...
sigma.publicPrototype.parseGexf = function(gexfPath) {
    ...
    var startNode = gexf.getElementsByTagName('graph')[0].attributes.start.nodeValue;
    var endNode = gexf.getElementsByTagName('graph')[0].attributes.end.nodeValue;
    ...
    for(i=0; i<edgesNodes.length; i++){
        ...
        for(j=0; j<edgeNodes.length; j++){
            ...
            var label = edgeNode.getAttribute('weight');
            var edge = {
                id:         id,
                sourceID:   source,
                targetID:   target,
